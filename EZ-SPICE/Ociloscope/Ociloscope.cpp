...
// Ociloscope.cpp : 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
// COciloscopeApp 사용자 지정 로드/저장 메서드
...
// COciloscopeApp 메시지 처리기



BOOL COciloscopeApp::InitSharedMemory()	//공유 메모리의 접근 포인터를 생성하는 곳
{
